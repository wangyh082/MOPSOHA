...
global archive fvals objFunOptions suREL suRED ix_solutions labellabel
...
% retrieve(¼ìË÷) populations size and number of attributes
nAttrs = size(X,2);
...
if ~isempty(archiveIx);
    ...
    elseif cardinality == 0
        ...
        [ACC,label] = trainAndValidateELM(PHI,Y,featIxes,nFolds,nELM,nUnits);
        ...
        labellabel = cat(1,labellabel,label);
    end  
end
