...
objFunOptions.nUnits         = 200;          % number of units in ELM
objFunOptions.maxCardinality = 200;         % maximum cardinality (important for large datasets)!!!!£¨the origin is 20 or 50)
